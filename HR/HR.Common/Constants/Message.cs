namespace HR.Common.Constants
{
    public class Message
    {
        ...
        public const string SUCCESS_SAVING_EMPLOYEE = "Employee has been saved successfully.";
        public const string SUCCESS_DELETING_EMPLOYEE = "Employee has been deleted successfully.";
    }
}
